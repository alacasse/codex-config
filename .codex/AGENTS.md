...
- Treat `skills/`, `agents/`, hooks, and `AGENTS.md` as production workflow code.
...
- `codex-features.json` lists only features owned by this repository. Vendor-owned skills, agents, and runtime state should not be added here.
