...
|---|---|---|---|---|---|---|
| 2. Add `planning-state current` | pending | | | | Validate contradictions and redirects | Reports active programs, selected dispatch, queued/active runways, latest closeout, and next safe action from Layout v1 `CURRENT.md` files. |
