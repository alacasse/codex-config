...
|---|---|---|---|---|---|---|
| 1. Define Pending finding vocabulary | Pending |  |  | Status-vocabulary regression fails before it passes | Pending is documented as a finding lifecycle status, not a batch artifact state. |
...
|---|---|---|---|
| 1. Define Pending finding vocabulary |  |  |  |
