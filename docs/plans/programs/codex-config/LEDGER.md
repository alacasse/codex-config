...
| CCFG-23. Build the Topology-Independent Behavioral Scenario Harness | Pending | [COR-006](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-006--ccfg-23--build-the-topology-independent-behavioral-harness) plus live harness scenarios in `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / behavioral harness | Continue active `batches/ccfg-23-behavioral-scenario-harness/runway.md` at Slice 2 through `work-batch` | Slice 1 closed in candidate commit `a5971caf0a34eaba005e0ad636d2235fb0260f31`; production ownership transfer, real cutover, and bridge deletion remain excluded and unselected. |
...
| `ccfg-23-behavioral-scenario-harness` | active | `docs/plans/programs/codex-config/batches/ccfg-23-behavioral-scenario-harness/dispatch.md` | `docs/plans/programs/codex-config/batches/ccfg-23-behavioral-scenario-harness/runway.md` | CCFG-23 | Slice 1 closed in candidate commit `a5971caf0a34eaba005e0ad636d2235fb0260f31`; continue at Slice 2. Production ownership transfer, real cutover/deletion, and successor selection are forbidden. |
...
3. `ccfg-23-behavioral-scenario-harness` is the sole active runway; resume it
   at Slice 2 only through `work-batch`.
