...
| CCFG-25. Transfer Planning Ownership to `plan-batch` | Pending | [COR-008](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-008--ccfg-25--transfer-planning-ownership-to-plan-batch), `findings/ccfg-25-planning-quality-amendment.md`, and `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / planning ownership | Resolve Slice 3 required-green BasedPyright command contract | Slice 3 static convergence commit `89671eceb9103039e7e6660e73837827c167a3a1` is focused-green and reviewed, but bare repository-wide BasedPyright fails at both the exact batch baseline (314 errors) and current candidate (311), with no diagnostics in CCFG-25 changed files. Installation, exact acceptance, final review, and closeout have not run; CCFG-26 remains preserved and no successor is selected. |
