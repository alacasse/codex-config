...
| CCFG-23. Build the Topology-Independent Behavioral Scenario Harness | Pending | [COR-006](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-006--ccfg-23--build-the-topology-independent-behavioral-harness) plus live harness scenarios in `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / behavioral harness | Continue active `batches/ccfg-23-behavioral-scenario-harness/runway.md` at Slice 3 through `work-batch` | Slices 1-2 closed through candidate commit `58cdf2d75d15db88136d33c9f6da29ab085030b4`; 27 contracts are green and the four State contracts remain deferred. Production ownership transfer, real cutover, and bridge deletion remain excluded. |
...
| `ccfg-23-behavioral-scenario-harness` | active | `docs/plans/programs/codex-config/batches/ccfg-23-behavioral-scenario-harness/dispatch.md` | `docs/plans/programs/codex-config/batches/ccfg-23-behavioral-scenario-harness/runway.md` | CCFG-23 | Slices 1-2 closed through candidate commit `58cdf2d75d15db88136d33c9f6da29ab085030b4`; continue at Slice 3. Production ownership transfer, real cutover/deletion, and successor selection are forbidden. |
...
3. `ccfg-23-behavioral-scenario-harness` is the sole active runway; resume it
   at Slice 3 only through `work-batch`.
4. Keep CCFG-24 through CCFG-29 and all older open rows unselected until a
   later explicit `plan-batch` request after CCFG-23 closeout.
