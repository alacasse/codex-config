...
| CCFG-25. Transfer Planning Ownership to `plan-batch` | Pending | [COR-008](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-008--ccfg-25--transfer-planning-ownership-to-plan-batch), `findings/ccfg-25-planning-quality-amendment.md`, and `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / planning ownership | Resume Slice 2 under a fresh strict lease at `5aa5add1251d1e4b3630a9678fdec244949cf691` | Active after a clean bounded amendment review. The exact runner-owner and support-skill caller ceiling is recorded in `batches/ccfg-25-planning-ownership-transfer/runway.md`; caller audit found no required edit outside it. Preserve CCFG-26 and select no successor. |
