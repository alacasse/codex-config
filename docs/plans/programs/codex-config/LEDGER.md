...
| `ccfg-26a-permanent-vertical-runway-contract` | queued | `docs/plans/programs/codex-config/batches/ccfg-26a-permanent-vertical-runway-contract/dispatch.md` | `docs/plans/programs/codex-config/batches/ccfg-26a-permanent-vertical-runway-contract/runway.md` | CCFG-26 | One vertical preparation slice: permanent candidate issue #60 planning behavior. Clean exact review at `batches/ccfg-26a-permanent-vertical-runway-contract/review.md`. |
| `ccfg-26b-fresh-slice-flight` | candidate | None | None | CCFG-26 | Deferred. Queue-to-worker/validation/review/commit through a fresh coordinator and durable flight receipt. Requires CCFG-26A closeout and a later explicit `plan-batch`. |
| `ccfg-26c-bounded-recovery` | candidate | None | None | CCFG-26 | Deferred. One read-only recovery advisor, bounded authority, independent amendment review, and fresh same-slice resume. Requires CCFG-26B and a later explicit `plan-batch`. |
| `ccfg-26d-finalization-flight` | candidate | None | None | CCFG-26 | Deferred. Last-slice receipt through a separate final validation/finalization flight. Requires CCFG-26C and a later explicit `plan-batch`. |
| `ccfg-26e-closeout-ownership-cutover` | candidate | None | None | CCFG-26 | Deferred. Finalization receipt through closeout/reconciliation/no-successor proof and last displaced semantic-owner narrowing. Requires CCFG-26D and a later explicit `plan-batch`. |
