...
| CCFG-25. Transfer Planning Ownership to `plan-batch` | Pending | [COR-008](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-008--ccfg-25--transfer-planning-ownership-to-plan-batch), `findings/ccfg-25-planning-quality-amendment.md`, and `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / planning ownership | Execute `batches/ccfg-25-planning-ownership-transfer/runway.md` through `work-batch` | Queued as a three-slice mixed-risk transfer: install the complete command owner and independent planning roles, remove APR/Batch Runway planning ownership, then converge exact acceptance. Preserve CCFG-26 execution/closeout responsibilities and stop without successor selection. |
...
| `ccfg-25-planning-ownership-transfer` | queued | `docs/plans/programs/codex-config/batches/ccfg-25-planning-ownership-transfer/dispatch.md` | `docs/plans/programs/codex-config/batches/ccfg-25-planning-ownership-transfer/runway.md` | CCFG-25 | Three-slice mixed-risk transfer; strict preflight required before execution; no successor selection. |
...
- CCFG-25 is queued at
  `batches/ccfg-25-planning-ownership-transfer/runway.md` and must preserve the
