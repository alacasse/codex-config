...
3. No batch is selected or queued. CCFG-24 is dependency-eligible but remains
   open and unselected; a later explicit `plan-batch` request owns selection.
4. Keep CCFG-24 through CCFG-29 and all older open rows unselected until
