...
| CCFG-25. Transfer Planning Ownership to `plan-batch` | Pending | [COR-008](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-008--ccfg-25--transfer-planning-ownership-to-plan-batch), `findings/ccfg-25-planning-quality-amendment.md`, and `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / planning ownership | Amend and independently review Slice 2 scope before deletion | Active but blocked after Slice 1 commit `5aa5add1251d1e4b3630a9678fdec244949cf691`. Required runner semantics and active support-skill callers lie outside the current Slice 2 path ceiling; see `batches/ccfg-25-planning-ownership-transfer/execution-report.md`. Preserve CCFG-26 and select no successor. |
...
| `ccfg-25-planning-ownership-transfer` | blocked | `docs/plans/programs/codex-config/batches/ccfg-25-planning-ownership-transfer/dispatch.md` | `docs/plans/programs/codex-config/batches/ccfg-25-planning-ownership-transfer/runway.md` | CCFG-25 | Slice 1 committed as `5aa5add1251d1e4b3630a9678fdec244949cf691`; Slice 2 needs a reviewed scope amendment; no successor selection. |

## Recommended Work Order

1. Start pickup from root and program `CURRENT.md`.
2. CCFG-18 through CCFG-24 and CCFG-30 through CCFG-33 are closed.
3. Amend and independently review the active
   `ccfg-25-planning-ownership-transfer` Slice 2 path scope before any deletion.
...
- CCFG-25 is active at
  ...
  bound to the exact dispatch and runway hashes, Slice 1 is committed as
  `5aa5add1251d1e4b3630a9678fdec244949cf691`, Slice 2 is blocked on a reviewed
  scope amendment, and every later handoff requires a freshly prepared strict
  lease.
