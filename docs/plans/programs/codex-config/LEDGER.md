...
| CCFG-25. Transfer Planning Ownership to `plan-batch` | Pending | [COR-008](https://github.com/alacasse/codex-config/blob/caf343a14bf8dae5ba3bfda6d8ab974929bb4c7c/docs/design/command-owner-redesign/07-implementation-ledger-intake.md#cor-008--ccfg-25--transfer-planning-ownership-to-plan-batch), `findings/ccfg-25-planning-quality-amendment.md`, and `findings/command-owner-redesign-planning-execution-carry-forward.md` | Command-owner redesign / planning ownership | Continue Slice 2 in `batches/ccfg-25-planning-ownership-transfer/runway.md` | Active three-slice mixed-risk transfer. Slice 1 committed as `5aa5add1251d1e4b3630a9678fdec244949cf691` with installed-owner validation and clean independent, import-topology, and delta-only test-quality reviews. Preserve CCFG-26 execution/closeout responsibilities and stop without successor selection. |
...
- CCFG-25 is active at
  ...
  `5aa5add1251d1e4b3630a9678fdec244949cf691`, and every later handoff requires a
  freshly prepared strict lease.
