...
- `programs/architecture-program-runner/CURRENT.md`: architecture-program
  runner pickup state.
- `programs/architecture-program-runner/LEDGER.md`: architecture-program
  runner Program Ledger.
- `programs/planning-state-tooling/CURRENT.md`: planning-state tooling pickup
  state.
- `programs/planning-state-tooling/LEDGER.md`: planning-state tooling Program
  Ledger.
